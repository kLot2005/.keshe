...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="pt-28 sm:pt-36 pb-16 px-4 sm:px-6 max-w-6xl mx-auto w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        >
          {/* Status Badge */}
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-slate-100/90 border border-slate-200/80 px-3.5 py-1.5 rounded-full text-xs font-medium text-slate-700">
          ...
          {/* Bio Description */}
          <motion.p variants={itemVariants} className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-xl">
            I create beautiful, functional, and user-centered digital experiences. With strong expertise in web engineering, modern frameworks, and AI systems, I bring ideas to life through clean code and thoughtful design.
          </motion.p>

          {/* Metadata Badges */}
          <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-4 text-xs font-medium text-slate-600 pt-1">
          ...
          {/* Divider Line */}
          <motion.div variants={itemVariants} className="pt-4 border-b border-slate-200"></motion.div>

          {/* Social Links Row */}
          <motion.div variants={itemVariants} className="flex items-center gap-4 text-sm text-slate-600 font-medium">
            <span>Follow me:</span>
          ...
          >
            ...
            <div className="px-2.5 py-1 flex items-center justify-between text-xs font-medium text-slate-700">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></span>
                <span className="font-bold text-slate-900">Bishimbay Bekarys</span>
              </div>
