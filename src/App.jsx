            ...
            <div className="relative overflow-hidden cursor-pointer flex transition-all duration-300 hover:scale-[1.01] bg-slate-800/50 backdrop-blur-[4px] rounded-4xl h-64">
              ...
              <div className="flex-1 flex gap-6 relative z-10">
                <div className="flex flex-col gap-3 p-6">
                  <div className="grow flex flex-col sm:flex-row gap-6">
                  ...
                  <div class="bg-slate-700/50 flex items-center gap-3 w-fit px-6 py-1 rounded-2xl hover:scale-[0.9]">
                    <div class="text-slate-400 text-sm">View</div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
